...
sed -i -E "s#(distributionUrl)=.*#\1=file\\:///project/linglong/sources/gradle-8.5-bin.zip#" gradle/wrapper/gradle-wrapper.properties
sed -i -E "s#(distributionSha256Sum)=.*#\1=9d926787066a081739e8200858338b4a69e837c3a821a33aca9db09dd4a41026#" gradle/wrapper/gradle-wrapper.properties
